package com.example.edo.studiebarometer.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public DatabaseHelper(Context ctx) {				// De constructor
        super(ctx, dbName, null, dbVersion);			// … de super constructor
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS "+ Databaseinfo.CourseTables.COURSE);	 // GOOIT ALLES WEG
